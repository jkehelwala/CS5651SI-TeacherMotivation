...
proportion_summary <<- c("Test", "Proportion", "successes", "CI Low", "CI High", "p-value", "sample_size", "HT")
mean_summary <<- c("Test", "Mean difference", "t-Statistic",  "CI Low", "CI High", "p-value", "df", "HT")
single_mean_summary <<- c("Test", "Mean", "t-Statistic",  "CI Low", "CI High", "p-value", "df", "HT")
